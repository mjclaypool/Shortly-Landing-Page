...
export default function GetStarted() {
  return (
    <div className="relative flex flex-col items-center justify-center gap-4 lg:gap-8 h-[250px] bg-primary-dark-violet font-poppins">
      <div className="absolute z-0">
        <img src={bgImgD} alt="Background geometric shapes" className="hidden lg:block h-[250px] w-[100vw] object-cover" />
